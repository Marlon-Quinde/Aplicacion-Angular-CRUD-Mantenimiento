...
const routes: Routes = [
  {
    ...
    children:[
       ...
       {
          path: 'usuarios',
          loadChildren: ()  => import('./components/mantenimiento-usuarios/mantenimiento-usuarios.module').then( m => m.MantenimientoUsuariosModule)
       },
       {
          path: 'perfiles',
          loadChildren: () => import('./components/mantenimiento-perfiles/mantenimiento-perfiles.module').then( m => m.MantenimientoPerfilesModule)
       },
       {
          path: 'clientes',
